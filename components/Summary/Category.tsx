...
import { getHackerRankMaxLanguageUsed, getHackerRankTotalProblemSolved } from "../../store/platforms/hackerrank";
...
export default function CategorySummary() {
  ...
  const hackerRankMaxLanguageUsed = UseAppSelector(getHackerRankMaxLanguageUsed);
  ...
  if (hackerRankMaxLanguageUsed) programmingLanguageUser += ", " + hackerRankMaxLanguageUsed
